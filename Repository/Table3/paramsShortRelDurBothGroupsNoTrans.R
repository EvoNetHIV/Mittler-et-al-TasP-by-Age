...
evoparams$prob_care                = 0.95 # Percent population that could get treated given "all out" campaign
...
evoparams$prob_tx_droput  = 0.0   # Probability of "V"-type agent discontinuing therapy over the course of a year
...
evoparams$mean_test_interval_male  =  3*365  #  Default value for people who aren't already requesting testing
evoparams$mean_test_interval_female = 3*365 #  50*365 would mean ~2% of nontesters come in for testing per year.
evoparams$mean_test_interval_under25 =3*365 #  50*365 would mean ~2% of nontesters come in for testing per year.
...
D1 = 20     # Duration preference for people in group 1-1 pairs (short-term relationships)
D2 = 365  # Duration preference for people in group 2-2 pairs (long-term relationships)
f1_0 = 0.25         # proportion of newly entering agents that have a preference/tendancy for short-term relationships
f2_0 = 0.75         # proportion of newly entering agents that have a preference/tendancy for long-term relationships
p_long <- 0.000  # Per day probability of an switching from short-to long-term preference (0.00011 amounts to ~4% probability/year)
f1 = 0.25          # Steady-state proportion of agents with a tendancy to form short-term relationships.  This value was determined empirically!
