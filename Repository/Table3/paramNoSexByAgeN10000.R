...
evoparams$initial_pop      = 10000 # New!
evoparams$initial_infected = 750 # New!
...
evoparams$prob_tx_droput  = 0.0   # Probability of "V"-type agent discontinuing therapy over the course of a year * CHANGED *
...
evoparams$mean_sex_acts_day  = 0.14 # used when prob_sex_by_age == FALSE
