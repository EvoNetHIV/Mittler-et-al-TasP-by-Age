...
evoparams$age_condom_use_halves = 350000
evoparams$condom_prob <- 0.35 # When condom_use_age == TRUE this gives probability that 16-year old uses condom, otherwise this is the probability for everyone
