...
D1 = 10     # Duration preference for people in group 1-1 pairs (short-term relationships)
D2 = 6*365  # Duration preference for people in group 2-2 pairs (long-term relationships)
f1_0 = 0.10         # proportion of newly entering agents that have a preference/tendancy for short-term relationships
f2_0 = 0.90         # proportion of newly entering agents that have a preference/tendancy for long-term relationships
p_long <- 0.0  # Per day probability of an switching from short-to long-term preference (0.00011 amounts to ~4% probability/year)
f1 = 0.1         # Steady-state proportion of agents with a tendancy to form short-term relationships.  This value was determined empirically!
