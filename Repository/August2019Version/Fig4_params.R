...
evoparams$initial_pop      = 10000 # Altered
evoparams$initial_infected = 750 # Altered
...
evoparams$prob_tx_droput  = 0.0   # Altered -- Probability of "V"-type agent discontinuing therapy over the course of a year
...
evoparams$trans_lambda  =  0.000247 * 15 * 1.3333 # some value times Hughes et al. (b/c they may be biased)  Further boosted since Equal Rel Durs and No Age Risks
...
evoparams$mean_sex_acts_day  = 0.20 # used when prob_sex_by_age == FALSE -- BUMPED UP FROM 0.14 FOR STRONGER EPIDEMIC
...
D1 = 5*365     # Duration preference for people in group 1-1 pairs (short-term relationships)
D2 = 5*365  # Duration preference for people in group 2-2 pairs (long-term relationships)
