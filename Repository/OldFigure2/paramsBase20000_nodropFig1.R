...
evoparams$initial_infected = 1500
...
evoparams$start_treat_before_big_campaign = 11*365 # Start time of gradual ramp-up prior to the start of the big TasP campaign
...
# Criteria for targeted TasP campaign (requires evonet function: "targeted_treatment2")  # NOTE CHANGE IN ORDER!
TasP_criteria = list(
  c("CD4_nadir_under500","random"),      # Immunological
  c("under25","under30","random"),
  c("under25","random"),
  c("random"),
  c("under25","under30","under35","random"),
...
evoparams$print_frequency = 365/5
evoparams$popsumm_frequency = 365/5
