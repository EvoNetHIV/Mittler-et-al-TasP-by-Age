...
evoparams$n_steps          = 45*365 # ** DIFFERENT  **
evoparams$nsims            = 16
evoparams$ncores            = 16


# Treatment campaign / limits on the number who can be treated
evoparams$start_treatment_campaign      = 20*365   # Start time of big TasP campaign  ** DIFFERENT **
evoparams$start_treat_before_big_campaign = 10*365 # Start time of gradual ramp-up prior to the start of the big TasP campaign
evoparams$proportion_treated = 1 # After the start of the TasP campaign *** Typically changed by calling script ***
evoparams$prop_tx_before = 1
evoparams$proportion_treated_begin = 0 # Treated before gradual ramp-up 
evoparams$prob_care                = 0.95 # Percent population that could get treated given "all out" campaign ** DIFFERENT **
evoparams$prob_eligible_ART        = 1.0
evoparams$tx_limit = "absolute_num" # Choices: "absolute_num" or percentage"
evoparams$yearly_incr_tx  = 0.10 # 0.05 means 5% more people get treated each year once campaign starts  ** DIFFERENT **
