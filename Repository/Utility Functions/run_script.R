param_set="N10000_80_under_care"
param_set_name=paste("params",param_set,sep="")
param_file=paste(param_set_name,".R",sep="")

 setwd("H://TasP2/Exp42_N10000_80_under_care")
source("H://TasP2/Exp42_N10000_80_under_care/paramsN10000_80_under_care.R") # Parameters for Tas-By-Age study


# Biological parameters specific to this simulation
exp_number = paste("Exp42_",param_set_name,"_",sep="")
