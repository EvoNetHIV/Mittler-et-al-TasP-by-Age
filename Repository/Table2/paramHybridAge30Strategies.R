...
TasP_criteria = list(
  c("random"),
  c("under25","random"),
  c("men_under35_women_under25","random"),      # Hybrid pivoting around age 25 skewed to older men
  c("men_under25_women_under_35","random"),      # Hybrid pivoting around age 25 skewed to older men
