...
TasP_criteria = list(
  c("random"),
  c("under25","random"),
  c("men_under27_women_under23","random"),      # Hybrid pivoting around age 25 skewed to older men
  c("men_under30_women_under20","random"),      # Hybrid pivoting around age 25 skewed to older men
  c("men_under23_women_under27","random"),      # Hybrid pivoting around age 25 skewed to older women
  c("men_under20_women_under30","random"),      # Hybrid pivoting around age 25 skewed to older women
