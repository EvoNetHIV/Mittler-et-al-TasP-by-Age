...
evoparams$mean_test_interval_male  =  2*365  #  Default value for people who aren't already requesting testing
evoparams$mean_test_interval_female = 2*365 #  50*365 would mean ~2% of nontesters come in for testing per year.
evoparams$mean_test_interval_under25 =2*365 #  50*365 would mean ~2% of nontesters come in for testing per year.
