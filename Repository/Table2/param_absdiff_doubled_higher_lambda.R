...
evoparams$trans_lambda  =  0.000247 * 20 # some value times Hughes et al. (b/c they may be biased)  
...
md= 0.75 # mean degree
male_female_age_diff = 4 # 4 means that women partner with men who are, on average, 84 years older than them
abs_diff_age = 8   # Difference in age AFTER accounting for the male-female age difference
